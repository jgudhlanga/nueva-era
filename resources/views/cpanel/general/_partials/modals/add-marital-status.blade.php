<div class="modal fade" id="addMaritalStatusModal" tabindex="-1" role="dialog" aria-labelledby="addMaritalStatusModal"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="addMaritalStatusForm"  role="form" data-toggle="validator">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        {{trans('marital-status.create')}}
