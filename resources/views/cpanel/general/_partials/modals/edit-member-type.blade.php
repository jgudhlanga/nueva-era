<div class="modal fade" id="editMemberTypeModal" tabindex="-1" role="dialog" aria-labelledby="editMemberTypeModal"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="editMemberTypeForm"  role="form" data-toggle="validator">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            <input type="hidden" name="edit_id" id="edit_id" value="">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        {{trans('members.types.edit')}}
