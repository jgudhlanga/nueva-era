<div class="modal fade" id="addMemberTypeModal" tabindex="-1" role="dialog" aria-labelledby="addMemberTypeModal"
     aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form id="addMemberTypeForm"  role="form" data-toggle="validator">
            <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                        {{trans('members.types.create')}}
